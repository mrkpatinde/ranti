    ...
    <div className="mt-6 rounded-2xl border border-border bg-card p-6 shadow-[0_14px_50px_-18px_rgba(41,41,41,0.22)]">
      ...
      {state === "verified" ? (
        <p className="rounded-xl border border-primary/15 bg-secondary px-4 py-3 text-sm text-foreground/80">
          Empreinte recalculée identique à celle scellée à l&apos;émission : ce
        ...
        <p className="rounded-xl border border-border bg-muted px-4 py-3 text-sm text-foreground/80">
          Ce document a bien été émis par Ranti, avant la mise en place du
          scellement automatique : aucune empreinte d&apos;intégrité n&apos;y est
          attachée. Son contenu ne peut pas être recoupé.
        </p>
      ) : state === "tampered" ? (
        <p className="rounded-xl border border-destructive/25 bg-destructive/10 px-4 py-3 text-sm text-destructive">
          L&apos;empreinte recalculée ne correspond pas à celle scellée à
          l&apos;émission. Ce document a été modifié depuis : il ne vaut pas preuve
          de paiement.
        </p>
      ) : (
        <p className="rounded-xl border border-destructive/25 bg-destructive/10 px-4 py-3 text-sm text-destructive">
