// Squelette au gabarit EXACT de la page encaissements (max-w-3xl, mêmes
// paddings) : la nav peint cette silhouette instantanément (frontière
// prefetchée), puis le cadre réel la remplace sans aucun saut de mise en page.
    ...
    >
      ...
      <section className="flex flex-1 flex-col gap-8 py-12">
        <div className="space-y-3">
          ...
          <div className="h-11 w-44 animate-pulse rounded-full bg-muted motion-reduce:animate-none" />
        </div>
