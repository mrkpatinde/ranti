      ...
      <section className="flex flex-1 flex-col gap-8 py-10">
        ...
        {unpaid.length === 0 ? (
          ...
          <form action={allocateReception} className="space-y-6">
            ...
            <SubmitButton className="w-full rounded-full bg-accent px-5 py-3.5 text-sm font-semibold text-accent-foreground shadow-[0_6px_16px_-6px_rgba(91,111,0,0.45)] transition hover:brightness-95 disabled:opacity-60">
