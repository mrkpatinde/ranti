// Squelette au gabarit des écrans mandants (max-w-3xl, mêmes paddings).
  ...
  return (
    ...
    >
      ...
      <section className="flex flex-1 flex-col gap-8 py-12">
        ...
        <div className="space-y-3">
          <div className="h-20 animate-pulse rounded-2xl border border-border bg-card motion-reduce:animate-none" />
          <div className="h-20 animate-pulse rounded-2xl border border-border bg-card motion-reduce:animate-none" />
          <div className="h-20 animate-pulse rounded-2xl border border-border bg-card motion-reduce:animate-none" />
        </div>
      </section>
