-- Ranti: fix record_collection ambiguous reference
-- Target: PostgreSQL 17 / Supabase
-- The allocations insert aliased jsonb_array_elements() as `a`, which clashed
-- with the plpgsql loop variable `a` (42702 ambiguous column reference). Rename
-- the alias to `el`. (Folded into 012 for fresh resets; this keeps the live
-- project consistent.)
